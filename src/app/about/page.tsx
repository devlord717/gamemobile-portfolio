              ...
              <div className="row">
                <div className="about-text padd-15">
                  <h2>
                    ...
                    <span>Talent Mobile & Game developer</span>
                  </h2>
                  <p>
                  Accomplished Mobile and Full-Stack Developer with 4+ years of experience specializing in cutting-edge technologies, including Flutter, blockchain integration, and scalable software architecture. Proven expertise in designing and delivering user-focused applications and games for industries like gaming, logistics, and e-commerce. Adept at solving complex challenges, optimizing systems, and creating engaging, high-performance software. Passionate about innovation and committed to achieving exceptional results in every project.
                  </p>
                </div>
              </div>
              <div className="row">
